...
if GEMINI_API_KEY and genai:
    try:
        ...
        model = genai.GenerativeModel(
            model_name='gemini-2.5-flash',   # ← 已改为你截图中的模型
            safety_settings={
        ...
        logger.info("✅ Gemini 2.5 Flash 模型加载成功")
...
# 按钮处理器、命令、主函数等保持完整（与上一个版本一致）
# （为避免过长，这里省略了重复部分，请确保完整复制）
